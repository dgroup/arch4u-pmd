...
[![Known Vulnerabilities](https://snyk.io/test/github/dgroup/arch4u-pmd/badge.svg)](https://snyk.io/org/dgroup/project/4a9f3433-7da5-4c24-985e-ee1d3077c458/?tab=dependencies\&vulns=vulnerable)
...
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=dgroup_arch4u-pmd\&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=dgroup_arch4u-pmd)
[![Codebeat Badge](https://codebeat.co/badges/ef2fc64b-b2cf-4cc5-8b01-c9b4baaae87a)](https://codebeat.co/projects/github-com-dgroup-arch4u-pmd-master)
[![Codacy Badge](https://app.codacy.com/project/badge/Grade/eb956780f5b34519ac193c204062acae)](https://www.codacy.com/gh/dgroup/arch4u-pmd/dashboard?utm_source=github.com\&utm_medium=referral\&utm_content=dgroup/arch4u-pmd\&utm_campaign=Badge_Grade)
...
```
See [more](./src/main/java/io/github/dgroup/arch4u-pmd/Enumerable.java).

### How to use

1.  Get the latest version [here](https://github.com/dgroup/arch4u-pmd/releases):
    ```xml
    <dependency>
    ...
    ```
2.  Assign the [Enumerable](./src/main/java/io/github/dgroup/arch4u-pmd/Enumerable.java) interface with default methods to your own collection
    ```java
    /**
    ...
    ```
    You may (but not required) override the default implementations of methods from [Enumerable](./src/main/java/io/github/dgroup/arch4u-pmd/Enumerable.java) if needed.

3.  Java version required: 1.8+.
4.  Comparing matrix with other libs:
    
    arch4u-pmd (MIT) | Java 8 | [cactoos](https://github.com/yegor256/cactoos) (MIT) | [eclipse-collections]() (EDL) 
    |------ | ------ | ------ |------ |
